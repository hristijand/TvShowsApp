...
namespace TvShowsApp.Controllers
{
    ...
    public class TvShowsController : Controller
    {
        ...
        {
            ViewData["UsersID"] = new SelectList(_context.Users, "UserId", "Name");
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tvShow = await _context.TvShow
                .FirstOrDefaultAsync(m => m.TvShowsId == id);
            if (tvShow == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TvShowsId,Title,Genre,Rating,ImdbUrl,ImageUrl")] TvShow tvShow)
        {
            if (id != tvShow.TvShowsId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!TvShowExists(tvShow.TvShowsId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.TvShow.Any(e => e.TvShowsId == id);
        }
    }
}
